...
contract DSCEngine is ReentrancyGuard {
    ...
    event Log(string message, uint256 info);
     ...
     * @notice This functions working assumes the protocol will be roughly 200% overcollateralize in order for this to work
    ...
    function _revertIfHealthFactorIsBroken(address user) internal {
        ...
        emit Log("health factor is:", userHealthFactor);
